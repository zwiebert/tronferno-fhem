...
<ul>
  ...
  <li>mcu-config.baud<br>
    Baud rate of MCU's serial interface</li><br>

  <a name="mcu-config.cu"></a>
  <li>mcu-config.cu<br>
   Central-Unit ID used by the MCU (six digit hex number)</li><br>


  <a name="mcu-config.latitude"></a>
  <li>mcu-config.latitude<br>
   geographical coordinates are used to calculate civil dusk for astro-timer (decimal degree, e.g. 52.5)</li><br>

  <a name="mcu-config.longitude"></a>
  <li>mcu-config.longitude<br>
   geographical coordinates are used to calculate civil dusk for astro-timer (decimal degree, e.g. 13,4)</li><br>

  <a name="mcu-config.restart"></a>
  <li>mcu-config.restart<br>
    causes the MCU to reastart. required after changing wlan configuration</li><br>

  <a name="mcu-config.rtc"></a>
  <li>mcu-config.rtc<br>
    Set MCU's internal real time clock by ISO date/time string (e.g. 1999-12-31T23:59:00). If possible, the MCU will use NTP instead.</li><br>
  ...
  <li>mcu-config.tz<br>
    Time-zone in POSIX (TZ) format</li><br>
  ...
  <li>mcu-config.verbose<br>
    Verbosity level of MCU's diagnose output (0 .. 5)</li><br>

  <a name="mcu-config.wlan-password"></a>
  <li>mcu-config.wlan-passord<br>
    Password used by MCU to connect to WLAN/WiFi </li><br>

  <a name="mcu-config.wlan-ssid"></a>
  <li>mcu-config.wlan-ssid<br>
    WLAN/WiFi SSID to connect to</li><br>
